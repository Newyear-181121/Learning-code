	...
	(x.fn = x.prototype = {
		...
		x.extend({
			...
			type: function(e) {
				return null == e
					? e + ''
					: 'object' == typeof e || 'function' == typeof e ? l[m.call(e)] || 'object' : typeof e;
			},
		...
		(function(e, undefined) {
			...
			function ut(e, t, n, r) {
				...
				if (p && !r) {
					...
					if (b.qsa && (!h || !h.test(e))) {
						if (
							((g = d = y), (x = t), (w = 9 === a && e), 1 === a && 'object' !== t.nodeName.toLowerCase())
						) {
							(f = gt(e)),
							...
							b.getById
								...
								: ((r.find.ID = function(e, t) {
										if (typeof t.getElementById !== j && p) {
											...
											return n
												? n.id === e ||
													(typeof n.getAttributeNode !== j && n.getAttributeNode('id').value === e)
													? [ n ]
													: undefined
												: [];
										}
							...
							(S = f.compareDocumentPosition
								? function(e, n) {
										...
										return r
											? 1 & r || (!b.sortDetached && n.compareDocumentPosition(e) === r)
												? e === t || m(v, e)
													? -1
													: n === t || m(v, n) ? 1 : u ? F.call(u, e) - F.call(u, n) : 0
												: 4 & r ? -1 : 1
								...
								: function(e, n) {
										...
										if (!o || !s)
											return e === t
												? -1
												: n === t ? 1 : o ? -1 : s ? 1 : u ? F.call(u, e) - F.call(u, n) : 0;
			...
			function ct(e, t, n) {
				...
				return n
					? undefined
					: (r = e.getAttributeNode(t)) && r.specified ? r.value : e[t] === !0 ? t.toLowerCase() : null;
			}
			function ft(e, t, n) {
				var r;
			...
			remove: function(e, t) {
				...
				if (t === undefined) this.cache[i] = {};
					...
					x.isArray(t)
						...
						: t in o ? (r = [ t ]) : ((r = x.camelCase(t)), (r = r in o ? [ r ] : r.match(w) || [])),
						(n = r.length);
				...
				try {
					n =
						'true' === n
							...
							: 'false' === n
								? !1
								: 'null' === n ? null : +n + '' === n ? +n : H.test(n) ? JSON.parse(n) : n;
				} catch (i) {}
				L.set(e, t, n);
			} else n = undefined;
		return n;
			...
			if (m && (u = m.events)) {
				...
				while (l--)
					if (((a = X.exec(t[l]) || []), (h = g = a[1]), (d = (a[2] || '').split('.').sort()), h)) {
						...
						s &&
							!p.length &&
							((f.teardown && f.teardown.call(e, d, m.handle) !== !1) || x.removeEvent(e, h, m.handle),
							delete u[h]);
	...
	x.fn.extend({
		...
		is: function(e) {
			return (
				!!e &&
				('string' == typeof e
					? J.test(e) ? x(e, this.context).index(this[0]) >= 0 : x.filter(e, this).length > 0
		...
		x.cssHooks[t] = {
			...
			set: function(e, n, r) {
				...
				return Ht(
					e,
					n,
					r ? Ot(e, t, r, x.support.boxSizing && 'border-box' === x.css(e, 'boxSizing', !1, i), i) : 0
				);
			}
		};
	}),
